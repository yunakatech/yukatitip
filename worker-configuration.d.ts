/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bd8256d872afa4d5ce537ff0f583e3b4)
// Runtime types generated with workerd@1.20260708.1 2026-07-11 nodejs_als
interface __BaseEnv_Env {
	YUKATITIP_CONFIG_KV: KVNamespace;
	YUKATITIP_PRIVATE_BUCKET: R2Bucket;
	YUKATITIP_PUBLIC_BUCKET: R2Bucket;
	...
	R2_PRIVATE_BUCKET_BINDING: string;
	R2_PUBLIC_BUCKET_BINDING: string;
	PUBLIC_ASSET_BASE_URL: string;
	KV_CONFIG_BINDING: string;
	CSRF_SECRET: string;
	...
	R2_DOWNLOAD_URL_TTL_SECONDS: string;
	TRACKING_RATE_LIMIT_REQUESTS: string;
	TRACKING_RATE_LIMIT_WINDOW_SECONDS: string;
	LOGIN_RATE_LIMIT_REQUESTS: string;
	LOGIN_RATE_LIMIT_WINDOW_SECONDS: string;
	ORDER_CREATE_RATE_LIMIT_REQUESTS: string;
	ORDER_CREATE_RATE_LIMIT_WINDOW_SECONDS: string;
	DEFAULT_CURRENCY: string;
	DEFAULT_LOCALE: string;
	DEFAULT_PAGE_SIZE: string;
	MAX_PAGE_SIZE: string;
	TRACKING_PHONE_LAST_DIGITS: string;
	ENABLE_DEV_SEED: string;
	ENABLE_DEBUG_ROUTES: string;
	DISABLE_TURNSTILE_IN_LOCAL: string;
	MOCK_R2_UPLOADS: string;
}
